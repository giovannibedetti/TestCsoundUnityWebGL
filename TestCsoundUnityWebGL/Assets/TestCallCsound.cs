...
public class TestCallCsound : MonoBehaviour
{
    ...
    private static extern void csoundInitialize(int id, int variation, string filesToLoad, string csdText, int callback);
    ...
    private static void OnCsoundInitialized(int instanceId)
    {
        ...
        //_thisInstance = instanceId;

        _instances.Add(instanceId);
        //_initialized = true;
        Debug.Log("csoundInitialize result from C#: " + instanceId );
        // play instrument 1 forever
        csoundInputMessage(0, "i1 0 -1");
    }
    ...
    {
        //if (_thisInstance != instanceId) return;
    ...
    void Start()
    {
        ...
        // _createButton.onClick.AddListener(InitializeCsoundInstance);
        // _sendButton.onClick.AddListener(()=> { csoundInputMessage(0, "i1 0 z"); });
    ...
    private void InitializeCsoundInstance()
    {
        ...
        // 
        csoundInitialize(UniqueId, 3, binauralTest, filesToLoad, Marshal.GetFunctionPointerForDelegate((CsoundInitializeCallback)OnCsoundInitialized).ToInt32());
    }
